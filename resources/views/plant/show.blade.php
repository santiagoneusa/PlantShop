            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-auto">
                                ...
                                <input type="number" min="1" max="{{ $viewData['plant']->getStock() }}" class="form-control quantity-input" name="quantity" value="1">
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <form method="POST" action="{{ route('review.save') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control mb-2 mt-2" name="stars"
                            placeholder="How would you rate this product on a scale of one to five?">
                        <br>
                    </div>
