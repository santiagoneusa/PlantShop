...
<div class="m-3 row">
    ...
    <div class="d-flex justify-content-center mt-4">  <form action="{{ route('admin.plant.edit', ['id' => $viewData["plant"]->getId()]) }}" method="post" enctype="multipart/form-data">
            <button class="btn btn-primary me-2">Edit</button>  </form>
        <form action="{{ route('admin.plant.delete', ['id' => $viewData["plant"]->getId()]) }}" method="post" enctype="multipart/form-data">
